...
# flat-nodes
if [ -f /data/database/renderer/flat_nodes.bin ]; then
    OSM2PGSQL_OPTIONS="${OSM2PGSQL_OPTIONS} --flat-nodes /data/database/renderer/flat_nodes.bin"
fi
...
#------------------------------------------------------------------------------
TRIM_POLY_FILE="/data/database/renderer/region.poly"
